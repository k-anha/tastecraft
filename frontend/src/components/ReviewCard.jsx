    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 p-6 shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100 dark:border-slate-800">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {reviewer.role === 'owner' && (
                <span className="px-2 py-0.5 rounded-full bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 text-[10px] font-bold flex items-center gap-1 border border-amber-200/50 dark:border-amber-800/50">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 mt-0.5">
              ...
              {review.visit_date && (
                <>
                  <span>•</span>
                  <span className="text-slate-500 dark:text-slate-400 font-medium">Visited: {review.visit_date}</span>
                </>
              )}
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          {canModify && (
            <div className="flex items-center gap-1 mr-1">
              <button
                ...
                className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 hover:text-brand-600 dark:hover:text-brand-400 transition-colors text-xs flex items-center gap-1"
              ...
              <button
                ...
                disabled={deleting}
                className="p-1.5 rounded-lg border border-rose-200 dark:border-rose-900/50 hover:bg-rose-50 dark:hover:bg-rose-950/30 text-rose-600 dark:text-rose-400 transition-colors text-xs flex items-center gap-1"
          ...
          <div className="flex items-center gap-2 bg-amber-50 dark:bg-amber-950/40 border border-amber-200/70 dark:border-amber-800/60 px-3 py-1.5 rounded-xl">
      ...
      {isEditing ? (
        <form onSubmit={handleSaveEdit} className="my-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 space-y-4">
          ...
          <div>
            <label className="block text-[11px] font-bold text-slate-700 dark:text-slate-300 uppercase mb-1">Headline</label>
            <input
              type="text"
              required
              value={editTitle}
              onChange={(e) => setEditTitle(e.target.value)}
              className="w-full text-xs rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-2.5 text-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-brand-500 font-semibold"
            />
          </div>

          <div>
            <label className="block text-[11px] font-bold text-slate-700 dark:text-slate-300 uppercase mb-1">Detailed Story</label>
            <textarea
              rows={3}
              required
              value={editContent}
              onChange={(e) => setEditContent(e.target.value)}
              className="w-full text-xs rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-2.5 text-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-brand-500"
            />
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-1">
            <div>
              <label className="block text-[10px] font-bold text-orange-700 dark:text-orange-400 uppercase">Food (1-5)</label>
              <input
                type="number"
                min="1"
                max="5"
                ...
                className="w-full text-xs rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-1.5 text-slate-800 dark:text-slate-100 font-bold"
              />
            </div>
            <div>
              <label className="block text-[10px] font-bold text-emerald-700 dark:text-emerald-400 uppercase">Value (1-5)</label>
              <input
                type="number"
                min="1"
                max="5"
            ...
            <div>
              <label className="block text-[10px] font-bold text-blue-700 dark:text-blue-400 uppercase">Service (1-5)</label>
              <input
                type="number"
                min="1"
                max="5"
            ...
            <div>
              <label className="block text-[10px] font-bold text-purple-700 dark:text-purple-400 uppercase">Ambiance (1-5)</label>
              <input
                type="number"
                min="1"
                max="5"
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            <button
              type="button"
              onClick={() => setIsEditing(false)}
              className="px-3.5 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 text-xs font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800"
            >
              Cancel
            </button>
            <button
        ...
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 my-4">
            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-orange-50/70 dark:bg-orange-950/30 border border-orange-100 dark:border-orange-900/30">
              <Utensils className="w-3.5 h-3.5 text-orange-600 dark:text-orange-400 flex-shrink-0" />
              <div className="flex flex-col">
                <span className="text-[10px] uppercase font-bold text-orange-700 dark:text-orange-400">Food</span>
                <span className="text-xs font-extrabold text-slate-800 dark:text-slate-200">{review.food_rating.toFixed(1)} / 5.0</span>
              </div>
            </div>

            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-emerald-50/70 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/30">
              <DollarSign className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
              <div className="flex flex-col">
                <span className="text-[10px] uppercase font-bold text-emerald-700 dark:text-emerald-400">Value</span>
                <span className="text-xs font-extrabold text-slate-800 dark:text-slate-200">{review.price_rating.toFixed(1)} / 5.0</span>
              </div>
            </div>

            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-blue-50/70 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900/30">
              <HeartHandshake className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400 flex-shrink-0" />
              <div className="flex flex-col">
                <span className="text-[10px] uppercase font-bold text-blue-700 dark:text-blue-400">Service</span>
                <span className="text-xs font-extrabold text-slate-800 dark:text-slate-200">{review.service_rating.toFixed(1)} / 5.0</span>
              </div>
            </div>

            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-purple-50/70 dark:bg-purple-950/30 border border-purple-100 dark:border-purple-900/30">
              <Sparkles className="w-3.5 h-3.5 text-purple-600 dark:text-purple-400 flex-shrink-0" />
              <div className="flex flex-col">
                <span className="text-[10px] uppercase font-bold text-purple-700 dark:text-purple-400">Ambiance</span>
                <span className="text-xs font-extrabold text-slate-800 dark:text-slate-200">{review.ambiance_rating.toFixed(1)} / 5.0</span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 space-y-2">
          ...
          <div className="space-y-2">
            {review.dish_reviews.map((dish) => (
              <div
                key={dish.id}
                className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/70 border border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2"
              >
                <div className="space-y-0.5">
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-xs text-slate-900 dark:text-slate-100">{dish.dish_name}</span>
                    {dish.price_paid && (
                    ...
                    <span
                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-bold ${
                        dish.sentiment === 'recommended'
                          ...
                          ? 'bg-rose-100 dark:bg-rose-950/60 text-rose-800 dark:text-rose-300 border border-rose-200/50 dark:border-rose-800/50'
                  ...
                  {dish.comment && (
                    <p className="text-xs text-slate-600 dark:text-slate-400 italic">"{dish.comment}"</p>
                  )}
                </div>
                ...
                {dish.rating && (
                  <div className="flex items-center gap-1 self-start sm:self-center">
                    ...
                    <span className="text-xs font-bold text-slate-700 dark:text-slate-300">{dish.rating.toFixed(1)}</span>
                  </div>
                )}
              </div>
            ))}
          ...
          <div className="flex flex-wrap gap-2">
            {images.map((img, idx) => (
              <button
                ...
                className="relative group rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-brand-500"
              >
                <img
                  src={img}
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border transition-all ${
              isLiked
                ? 'bg-rose-50 dark:bg-rose-950/40 border-rose-200 dark:border-rose-900/50 text-rose-600 dark:text-rose-400 font-bold'
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 font-medium transition-all"
          >
                ...
                <div
                  ...
                  className={`p-3.5 rounded-2xl text-xs space-y-2 transition-all ${
                    comment.is_owner_response
                      ? 'bg-amber-50/80 dark:bg-amber-950/30 border border-amber-200/80 dark:border-amber-900/40'
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1.5">
                      {comment.is_owner_response && (
                        <span className="px-2 py-0.5 rounded-md bg-amber-200 dark:bg-amber-900/60 text-amber-900 dark:text-amber-200 text-[10px] font-bold flex items-center gap-1">
                        ...
                        <div className="flex items-center gap-1">
                          {isCommentAuthor && (
                            <button
                              ...
                              className="p-1 rounded text-slate-400 hover:text-brand-600 hover:bg-slate-200/60 dark:hover:bg-slate-700 transition-colors"
                  ...
                  {editingCommentId === comment.id ? (
                    <div className="space-y-2 pt-1">
                      <input
                        ...
                        className="w-full text-xs rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 px-3 py-2 text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-brand-500 font-medium"
                      />
                    ...
                    <p className="text-slate-700 dark:text-slate-300 leading-relaxed pl-1">{comment.content}</p>
                  )}
                </div>
              );
            })}
          ...
          {isAuthenticated ? (
            <form onSubmit={handleAddComment} className="flex gap-2 pt-1">
              <input
                ...
                className="flex-1 text-xs rounded-xl border border-slate-200 dark:border-slate-700 px-3.5 py-2 focus:outline-none focus:ring-2 focus:ring-brand-500 bg-slate-50/50 dark:bg-slate-800/80 text-slate-800 dark:text-slate-100"
              />
              <button
                type="submit"
